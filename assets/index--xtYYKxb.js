import{p as k,n as b,A as ne,q as s,B as se,L as p,Z as _,x as oe,z as re,c as z,M as ie,N as te,O as C,Q as E,R as T,S as i,a6 as V,a7 as m,a8 as v,a9 as le,r as de,w as ue}from"./index-gMo6Rprx.js";import{m as g,a as I,u as y,F as S,j as Y,G as N,E as A,i as j,b as ce,r as me,c as pe,s as ve,t as be,v as ge,d as ye,w as fe,k as he,R as qe,f as ze,x as je,l as ke,y as Ce,g as Ee,z as Se,A as Le,B as xe,h as _e,C as Ve,V as D,L as Ne,D as Ae,_ as Pe,J as Te}from"./VAvatar-cTqZn-nl.js";const Ie=k({fluid:{type:Boolean,default:!1},...g(),...I()},"VContainer"),Ye=b()({name:"VContainer",props:Ie(),setup(e,o){let{slots:n}=o;const{rtlClasses:a}=ne();return y(()=>s(e.tag,{class:["v-container",{"v-container--fluid":e.fluid},a.value,e.class],style:e.style},n)),{}}}),De=b()({name:"VCardActions",props:g(),setup(e,o){let{slots:n}=o;return se({VBtn:{slim:!0,variant:"text"}}),y(()=>{var a;return s("div",{class:["v-card-actions",e.class],style:e.style},[(a=n.default)==null?void 0:a.call(n)])}),{}}}),R=S("v-card-subtitle"),M=S("v-card-title"),Re=k({appendAvatar:String,appendIcon:p,prependAvatar:String,prependIcon:p,subtitle:[String,Number],title:[String,Number],...g(),...Y()},"VCardItem"),Me=b()({name:"VCardItem",props:Re(),setup(e,o){let{slots:n}=o;return y(()=>{var d;const a=!!(e.prependAvatar||e.prependIcon),t=!!(a||n.prepend),l=!!(e.appendAvatar||e.appendIcon),f=!!(l||n.append),h=!!(e.title!=null||n.title),q=!!(e.subtitle!=null||n.subtitle);return s("div",{class:["v-card-item",e.class],style:e.style},[t&&s("div",{key:"prepend",class:"v-card-item__prepend"},[n.prepend?s(j,{key:"prepend-defaults",disabled:!a,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},n.prepend):s(_,null,[e.prependAvatar&&s(N,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&s(A,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),s("div",{class:"v-card-item__content"},[h&&s(M,{key:"title"},{default:()=>{var r;return[((r=n.title)==null?void 0:r.call(n))??e.title]}}),q&&s(R,{key:"subtitle"},{default:()=>{var r;return[((r=n.subtitle)==null?void 0:r.call(n))??e.subtitle]}}),(d=n.default)==null?void 0:d.call(n)]),f&&s("div",{key:"append",class:"v-card-item__append"},[n.append?s(j,{key:"append-defaults",disabled:!l,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},n.append):s(_,null,[e.appendIcon&&s(A,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&s(N,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])])}),{}}}),B=S("v-card-text"),Be=k({appendAvatar:String,appendIcon:p,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:p,ripple:{type:[Boolean,Object],default:!0},subtitle:[String,Number],text:[String,Number],title:[String,Number],...ce(),...g(),...Y(),...me(),...pe(),...ve(),...be(),...ge(),...ye(),...fe(),...I(),...oe(),...he({variant:"elevated"})},"VCard"),Ue=b()({name:"VCard",directives:{Ripple:qe},props:Be(),setup(e,o){let{attrs:n,slots:a}=o;const{themeClasses:t}=re(e),{borderClasses:l}=ze(e),{colorClasses:f,colorStyles:h,variantClasses:q}=je(e),{densityClasses:d}=ke(e),{dimensionStyles:r}=Ce(e),{elevationClasses:U}=Ee(e),{loaderClasses:w}=Se(e),{locationStyles:Q}=Le(e),{positionClasses:H}=xe(e),{roundedClasses:F}=_e(e),u=Ve(e,n),O=z(()=>e.link!==!1&&u.isLink.value),c=z(()=>!e.disabled&&e.link!==!1&&(e.link||u.isClickable.value));return y(()=>{const $=O.value?"a":e.tag,X=!!(a.title||e.title!=null),G=!!(a.subtitle||e.subtitle!=null),J=X||G,Z=!!(a.append||e.appendAvatar||e.appendIcon),K=!!(a.prepend||e.prependAvatar||e.prependIcon),W=!!(a.image||e.image),ee=J||K||Z,ae=!!(a.text||e.text!=null);return ie(s($,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":c.value},t.value,l.value,f.value,d.value,U.value,w.value,H.value,F.value,q.value,e.class],style:[h.value,r.value,Q.value,e.style],href:u.href.value,onClick:c.value&&u.navigate,tabindex:e.disabled?-1:void 0},{default:()=>{var L;return[W&&s("div",{key:"image",class:"v-card__image"},[a.image?s(j,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},a.image):s(D,{key:"image-img",cover:!0,src:e.image},null)]),s(Ne,{name:"v-card",active:!!e.loading,color:typeof e.loading=="boolean"?void 0:e.loading},{default:a.loader}),ee&&s(Me,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:a.item,prepend:a.prepend,title:a.title,subtitle:a.subtitle,append:a.append}),ae&&s(B,{key:"text"},{default:()=>{var x;return[((x=a.text)==null?void 0:x.call(a))??e.text]}}),(L=a.default)==null?void 0:L.call(a),a.actions&&s(De,null,{default:a.actions}),Ae(c.value,"v-card")]}}),[[te("ripple"),c.value&&e.ripple]])}),{}}}),we={class:"font-italic text-body-2 pb-4"},Qe={class:"text-left text-body-2 px-lg-16 break-word"},He=C({__name:"Song",props:{song:{}},setup(e){const o=e,n=z(()=>"/src/assets/"+o.song.image);return(a,t)=>(E(),T(Ue,{class:"mx-lg-16"},{default:i(()=>[s(M,null,{default:i(()=>[V(m(a.song.name),1)]),_:1}),s(R,null,{default:i(()=>[V(" by "+m(a.song.artist),1)]),_:1}),s(B,{class:"text-wrap"},{default:i(()=>[v("pre",we," "+m(a.song.letter)+" ",1),v("p",Qe,m(a.song.description),1)]),_:1}),s(D,{class:"ma-3",src:n.value},null,8,["src"])]),_:1}))}}),Fe=Pe(He,[["__scopeId","data-v-9c587241"]]),Oe=v("h1",{class:"text-h2 my-2 font-weight-bold"},"Song Sense",-1),$e=v("div",{class:"text-subtitle-1 mt-3 mb-4"},"Una pagina que te dice que signifcan las letras de tus canciones favoritas",-1),Xe=[Oe,$e],Ge=C({__name:"TitleHeader",setup(e){return(o,n)=>(E(),le("div",null,Xe))}}),P=[{link:"dulce-soledad",name:"Dulce Soledad",artist:"Enjambre",letter:`Hoy bien pude estar acompañado
        ...
        "Ser Parte" es una oda al amor que trasciende, un canto que se eleva desde el alma de Siddhartha y se posa suavemente en nuestros corazones, recordándonos que en el amor, somos infinitos, somos uno con el universo.`}],Ke=C({__name:"index",props:{songName:{}},setup(e){const o=e,n=de(P.find(a=>a.link===o.songName));return ue(()=>o.songName,()=>{n.value=P.find(a=>a.link===o.songName)}),(a,t)=>(E(),T(Ye,{class:"fill-height"},{default:i(()=>[s(Te,{class:"text-center fill-height justify-center"},{default:i(()=>[s(Ge),s(Fe,{song:n.value},null,8,["song"])]),_:1})]),_:1}))}});export{Ke as default};
